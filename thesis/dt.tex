...
been crucial method to manage masses of computers. Protecting every
...
In this thesis I look for history and current state of network based
automatic installation systems based on what protocols do they
use. Then I identify risks to those protocols and see how the
situation could be improved by using cryptography (TLS protocol and
digital signatures).
