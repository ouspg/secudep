...
available tools to enable encryption and file signing. Next chapter
discusses proof of concept implementation of network installation
system and it's design principles. Then the proof of concept
implementation is compared to two other installation infrastructures.
